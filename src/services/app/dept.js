...
export function insertRow(action, config, options) {
  return request(action, config, {
    Url: `${apiPrefix}dept/insertDept${apiNexfix}`,
    method: 'POST',
    body: options,
  });
}
...
export function deleteRow(action, config, options) {
  return request(action, config, {
    Url: `${apiPrefix}dept/deleteArray${apiNexfix}`,
    method: 'POST',
    body: options,
  });
}
...
export function updateRow(action, config, options) {
  return request(action, config, {
    Url: `${apiPrefix}dept/updateDept${apiNexfix}`,
    method: 'POST',
    body: options,
  });
}
...
export function viewedRow(action, config, options) {
  return request(action, config, {
    Url: `${apiPrefix}dept/getDeptById${apiNexfix}`,
    method: 'POST',
    body: options,
  });
}
